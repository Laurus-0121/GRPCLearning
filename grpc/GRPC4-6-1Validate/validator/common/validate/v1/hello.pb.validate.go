...
func (m *Message) validate(all bool) error {
	...
	if len(m.GetImportantString()) > 30 {
		err := MessageValidationError{
			field:  "ImportantString",
	...
	if !_Message_ImportantString_Pattern.MatchString(m.GetImportantString()) {
		err := MessageValidationError{
			field:  "ImportantString",
...
var _Message_ImportantString_Pattern = regexp.MustCompile("[一-龥]")
